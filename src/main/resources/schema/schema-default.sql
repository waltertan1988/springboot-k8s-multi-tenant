...
insert into `acl_tenant_datasource` (`tenant_id`, `datasource_id`, `driver_class`, `jdbc_url`, `db_username`, `db_password`, `created_by`, `created_date`, `last_modified_by`, `last_modified_date`) values('A','fund','com.mysql.cj.jdbc.Driver','jdbc:mysql://mysql-endpoint.default.svc.cluster.local/tenant_a_fund?serverTimezone=UTC&useUnicode=true&characterEncoding=utf8','root','','*ADMIN','2020-02-15 23:45:51','*ADMIN','2020-02-15 23:46:00');
insert into `acl_tenant_datasource` (`tenant_id`, `datasource_id`, `driver_class`, `jdbc_url`, `db_username`, `db_password`, `created_by`, `created_date`, `last_modified_by`, `last_modified_date`) values('B','fund','com.mysql.cj.jdbc.Driver','jdbc:mysql://mysql-endpoint.default.svc.cluster.local/tenant_b_fund?serverTimezone=UTC&useUnicode=true&characterEncoding=utf8','root','','*ADMIN','2020-02-15 23:45:57','*ADMIN','2020-02-15 23:46:06');
insert into `acl_tenant_datasource` (`tenant_id`, `datasource_id`, `driver_class`, `jdbc_url`, `db_username`, `db_password`, `created_by`, `created_date`, `last_modified_by`, `last_modified_date`) values('A','product','com.mysql.cj.jdbc.Driver','jdbc:mysql://mysql-endpoint.default.svc.cluster.local/tenant_a_product?serverTimezone=UTC&useUnicode=true&characterEncoding=utf8','root','','*ADMIN','2020-02-15 23:45:51','*ADMIN','2020-02-15 23:46:00');
insert into `acl_tenant_datasource` (`tenant_id`, `datasource_id`, `driver_class`, `jdbc_url`, `db_username`, `db_password`, `created_by`, `created_date`, `last_modified_by`, `last_modified_date`) values('B','product','com.mysql.cj.jdbc.Driver','jdbc:mysql://mysql-endpoint.default.svc.cluster.local/tenant_b_product?serverTimezone=UTC&useUnicode=true&characterEncoding=utf8','root','','*ADMIN','2020-02-15 23:45:57','*ADMIN','2020-02-15 23:46:06');
